...
declare class veRTCEngine extends EventEmitter {
    ...
    */
     ...
     */
    getWindowAppIcon(sourceId: number, maxWidth: number, maxHeight: number): AppIconInfo;
    /** {zh}
     * @region 屏幕共享
     * @brief 发布本地屏幕共享流到房间。
     * @return
