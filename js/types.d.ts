...
export interface ScreenCaptureSourceInfo {
    ...
    source_id: number;
    /**
     * @brief 屏幕源名称，采集源为应用窗体有效
     */
    source_name: string;
    /**
     * @brief 应用名称，采集源为应用窗体有效
     */
    application: string;
    /**
     * @brief 是否主屏，采集源为屏幕时有效
     */
    primaryMonitor: boolean;
    /**
    * @brief 共享对象 x 坐标。多显示器的场景下，屏幕坐标系统以主屏左上角为原点 (0, 0)，向右向下扩展。
    */
    x: number;
    /**
    * @brief 共享对象 y 坐标。多显示器的场景下，屏幕坐标系统以主屏左上角为原点 (0, 0)，向右向下扩展。
    */
    y: number;
    /**
   * @brief 共享对象宽度
